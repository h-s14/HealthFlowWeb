...
const NavBar = () => {
  return (
    <>
      ...
      <div className="fixed left-1/2 top-[20px] z-10 hidden w-[90%] translate-x-[-50%] items-center justify-between gap-16 rounded-full bg-gray-100 bg-opacity-60 px-10 py-1 text-nav-bar-text-light shadow-lg backdrop-blur-md dark:bg-gray-950 dark:bg-opacity-60 dark:text-nav-bar-text-dark md:flex">
        <Nav />
        <Logo />
        <Auths />
      </div>
